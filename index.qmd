...
From [zhangdaren916](https://github.com/zhangdaren916/The-Dream-of-the-Red-Chamber/), I retrieved (and saved in /data) :
...
From [lileslll](https://github.com/lileslll/Dream_of_the_Red_Chamber_Character_Analysis/), I found a pearl :
...
with open("data/userdict_w_tradchar.json", "r", encoding="utf-8") as f:
